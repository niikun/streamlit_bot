...
groq_api_key = os.getenv('GLOQ_API_KEY')  # Groq API key
...
MODEL_NAMES = [
    ...
    "llama-3.3-70b-versatile",  # Model 3: Llama 3.1 with instant response
    "gemma2-9b-it"  # Model 4: Gemma 2 with Italian language
]
